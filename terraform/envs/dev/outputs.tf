output "artifact_registry_repository_id" {
  description = "Artifact Registry repository ID for the dev environment."
  value       = module.gke.artifact_registry_repository_id
}

output "billing_dataset_id" {
  description = "BigQuery dataset ID for billing usage events in the dev environment."
...
output "file_changes_subscription_name" {
  description = "Pub/Sub subscription name for workspace file changes in the dev environment."
  value       = module.file_changes.indexer_updater_subscription_name
}

output "file_changes_topic_name" {
  description = "Pub/Sub topic name for workspace file changes in the dev environment."
  value       = module.file_changes.file_changes_topic_name
}

output "indexer_updater_service_account_email" {
  description = "Indexer-updater service account email for the dev environment."
  value       = module.iam.indexer_updater_service_account_email
}

output "indexer_updater_service_uri" {
  description = "Public URI of the indexer-updater Cloud Run service for the dev environment."
...
output "usage_events_table_id" {
  description = "BigQuery table ID for usage events in the dev environment."
  value       = module.billing_events.usage_events_table_id
}

output "usage_events_topic_name" {
  description = "Pub/Sub topic name for usage events in the dev environment."
